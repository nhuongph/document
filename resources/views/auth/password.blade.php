                    ...
                    <div class="col-md-8 bg-white padding-top-bot col-md-offset-1">
                        <div class="col-md-8 col-md-offset-2 padding-top-bot">
                            ...
                            <div class="card card-container">
                                ...
                                <h1 class="text-center padding-top-bot">Forgot Password</h1>
                                @if (count($errors) > 0)
                                ...
                                <div class="form-group">
                                    {!! Form::label('email','We will send password via email.') !!}
                                    {!! Form::email('email', null, ['class' => 'form-control','placeholder'=>'Email registed account']) !!}
                                </div>
                                {!! Form::submit('Get mail reset password',['class' => 'btn btn-success']) !!}
                                {!! Form::close() !!}<!-- /form -->
                            </div><!-- /card-container -->
                            <!-- Start Carousel Section -->
                        </div>
